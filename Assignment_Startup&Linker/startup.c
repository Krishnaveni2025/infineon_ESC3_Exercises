...
/* NEW: Custom Section Linker Symbols */
...
/* Function to perform the custom section relocation */
void relocate_cosmic_constellation(void)
{
...
void Reset_handler(void)
{
    ...
    // Copy .cosmic_constellation from LMA to VMA
    relocate_cosmic_constellation();
